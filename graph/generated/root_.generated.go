...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.wishes":
		...
		return e.ComplexityRoot.Query.Wishes(childComplexity, args["semester"].(string), args["programme"].(*string), args["module"].(*string), args["instance"].(*string), args["person"].(*string)), true
...
`, BuiltIn: false},
	{Name: "../wish.graphqls", Input: `# Wishes: one person's interest in one course instance.
#
...
#
# WHAT A WISH POINTS AT
#
# The instance: one module, in one study programme, for one cohort. Not one of its parts, which is
# what migration 15 shipped and migration 16 corrected. The faculty plans at the granularity of
# "IF2A / Softwareentwicklung II", and that is the granularity people think in; which part
# somebody ends up holding is settled in the assignment, between the people concerned. Until then
# "ich mache die Vorlesung, das Praktikum jemand anderes" is what ` + "`" + `note` + "`" + ` is for.
#
...
# WHAT IS DELIBERATELY MISSING
#
# There is no count. No ` + "`" + `wishCount` + "`" + `, no ` + "`" + `hasWishes` + "`" + `, no "how many people want this" anywhere
