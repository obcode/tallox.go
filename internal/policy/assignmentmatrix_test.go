...
module — course instance → module → subject group — and never stored beside
it.
...
-----
  ...
  · A programme lead acts in no group here, and that is not the same as "a programme lead does
    not fill instances". It does, since 2026-08-27 — through the *other* axis, over the study
    programme of the instance rather than the subject of the module. This table is one of the two
    inputs to that rule; the write matrix shows how they combine. Read alone it answers only
    "whose subject is this", which is why a programme lead answers no to it and still writes.
